...
public class Page implements Serializable {
	...
	public Page(int id, int pageNumber, String storyText, int optionOnePageNumber, String optionOneText, int optionTwoPageNumber, String optionTwoText, int optionThreePageNumber, String optionThreeText, boolean earlyStoryEnd, boolean finalStoryEnd) {
		super();
		this.id = id;
