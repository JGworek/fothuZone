...
public class Pet implements Serializable {
    ...
    public Pet(int id, String name, Image image, String type, int hunger, int currentHealth, int maxHealth,
        int strength, int agility, int intelligence, int petLevel, int currentXP, int availableLevelUps, User owner) {
        super();
        this.id = id;
        this.name = name;
        this.image = image;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(agility, availableLevelUps, currentHealth, currentXP, hunger, id, image, intelligence,
            maxHealth, name, owner, petLevel, strength, type);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return agility == other.agility && availableLevelUps == other.availableLevelUps
            ...
            && id == other.id && Objects.equals(image, other.image) && intelligence == other.intelligence
            && maxHealth == other.maxHealth && Objects.equals(name, other.name) && Objects.equals(owner, other.owner)
    ...
    public String toString() {
        return "Pet [id=" + id + ", name=" + name + ", image=" + image + ", type=" + type + ", hunger=" + hunger
            ...
            + ", availableLevelUps=" + availableLevelUps + ", owner=" + owner + "]";
    }
}