...
public class BattleLog implements Serializable {
	...
	public BattleLog(int id, Battle battle, int turnNumber, String turnFlavorText, String turnTechnicalText, Boolean battleEnded) {
		super();
		this.id = id;
		this.battle = battle;
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(battle, other.battle) && Objects.equals(battleEnded, other.battleEnded) && id == other.id && Objects.equals(turnFlavorText, other.turnFlavorText) && turnNumber == other.turnNumber && Objects.equals(turnTechnicalText, other.turnTechnicalText);
	}

	@Override
	public String toString() {
		return "BattleLog [id=" + id + ", battle=" + battle + ", turnNumber=" + turnNumber + ", turnFlavorText=" + turnFlavorText + ", turnTechnicalText=" + turnTechnicalText + ", battleEnded=" + battleEnded + "]";
	}
}
