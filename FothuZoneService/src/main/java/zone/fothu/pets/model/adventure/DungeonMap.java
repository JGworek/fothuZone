...
public class DungeonMap implements Serializable {
	...
	public DungeonMap(int id, String name, int startingRoom, int bossRoom, int ladderRoom, int enemyLevel, int monsterSpawnRate, List<Integer> nonBarrenCells, Pet bossPet) {
		super();
		this.id = id;
		this.name = name;
	...
	@Override
	public int hashCode() {
		return Objects.hash(bossPet, bossRoom, enemyLevel, id, ladderRoom, monsterSpawnRate, name, nonBarrenCells, startingRoom);
	}
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(bossPet, other.bossPet) && bossRoom == other.bossRoom && enemyLevel == other.enemyLevel && id == other.id && ladderRoom == other.ladderRoom && monsterSpawnRate == other.monsterSpawnRate && Objects.equals(name, other.name) && Objects.equals(nonBarrenCells, other.nonBarrenCells) && startingRoom == other.startingRoom;
	}

	@Override
	public String toString() {
		return "DungeonMap [id=" + id + ", name=" + name + ", startingRoom=" + startingRoom + ", bossRoom=" + bossRoom + ", ladderRoom=" + ladderRoom + ", enemyLevel=" + enemyLevel + ", monsterSpawnRate=" + monsterSpawnRate + ", nonBarrenCells=" + nonBarrenCells + ", bossPet=" + bossPet + "]";
	}
}
