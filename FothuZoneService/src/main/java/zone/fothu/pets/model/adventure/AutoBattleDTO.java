...
public class AutoBattleDTO implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(battle, other.battle) && numberOfLevelUps == other.numberOfLevelUps
            && userVictory == other.userVictory;
    }

    @Override
    public String toString() {
        return "AutoBattleDTO [battle=" + battle + ", numberOfLevelUps=" + numberOfLevelUps + ", userVictory="
            + userVictory + "]";
    }
}
