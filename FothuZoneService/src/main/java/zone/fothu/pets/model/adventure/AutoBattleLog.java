...
public class AutoBattleLog implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(battle, other.battle) && Objects.equals(battleFinished, other.battleFinished)
            && id == other.id && turnNumber == other.turnNumber && Objects.equals(turnResult, other.turnResult)
            && Objects.equals(turnText, other.turnText);
    }

    @Override
    public String toString() {
        return "AutoBattleLog [id=" + id + ", battle=" + battle + ", turnNumber=" + turnNumber + ", turnText="
            + turnText + ", turnResult=" + turnResult + ", battleFinished=" + battleFinished + "]";
    }
}
