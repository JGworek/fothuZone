...
public class WebSocketController {
	...
	public void attackWithAttackingPet(@DestinationVariable int battleId, @DestinationVariable int petId, @Payload String userId) throws MessagingException, UserNotFoundException {
	...
	public void attackWithDefendingPet(@DestinationVariable int battleId, @DestinationVariable int petId, @Payload String userId) throws MessagingException, UserNotFoundException {
	...
	public void defendWithAttackingPet(@DestinationVariable int battleId, @DestinationVariable int petId, @Payload String userId) throws MessagingException, UserNotFoundException {
	...
	public void defendWithDefendingPet(@DestinationVariable int battleId, @DestinationVariable int petId, @Payload String userId) throws MessagingException, UserNotFoundException {
	...
	public void aimWithAttackingPet(@DestinationVariable int battleId, @DestinationVariable int petId, @Payload String userId) throws MessagingException, UserNotFoundException {
	...
	public void aimWithDefendingPet(@DestinationVariable int battleId, @DestinationVariable int petId, @Payload String userId) throws MessagingException, UserNotFoundException {
	...
	public void sharpenWithAttackingPet(@DestinationVariable int battleId, @DestinationVariable int petId, @Payload String userId) throws MessagingException, UserNotFoundException {
	...
	public void sharpenWithDefendingPet(@DestinationVariable int battleId, @DestinationVariable int petId, @Payload String userId) throws MessagingException, UserNotFoundException {
	...
	public void setAttackingPet(@DestinationVariable int battleId, @DestinationVariable int attackingPetId, @Payload String userId) throws WrongBattlePetException {
	...
	public void setDefendingPet(@DestinationVariable int battleId, @DestinationVariable int defendingPetId, @Payload String userId) throws WrongBattlePetException {
	...
	public void updateLoggedInUser(int userId) throws MessagingException, UserNotFoundException {
